...
START_TEST(s21_create_matrix_06) {
  ...
  ck_assert_int_eq(res, ERR_INCORRECT_MATRIX);
}
END_TEST
...
START_TEST(create_2) {
  ...
  const int cols = 10;
  matrix_t m = {0};
  ck_assert_int_eq(s21_create_matrix(rows, cols, &m), ERR_INCORRECT_MATRIX);
  s21_remove_matrix(&m);
}
END_TEST
...
START_TEST(transpose_matrix2) {
  ...
  matrix_t res = {0};
  ck_assert_int_eq(s21_transpose(&m, &res), ERR_INCORRECT_MATRIX);
...
START_TEST(sum_matrix2) {
  ...
  ck_assert_int_eq(s21_sum_matrix(&m, &mtx, &res), ERR_INCORRECT_MATRIX);
  s21_remove_matrix(&m);
  s21_remove_matrix(&mtx);
  s21_remove_matrix(&res);
}
...
START_TEST(sub_matrix2) {
  ...
  matrix_t res = {0};
  ck_assert_int_eq(s21_sub_matrix(&m, &mtx, &res), ERR_INCORRECT_MATRIX);
...
START_TEST(mult_matrix2) {
  ...
  matrix_t res = {0};
  ck_assert_int_eq(s21_mult_matrix(&m, &mtx, &res), ERR_INCORRECT_MATRIX);
